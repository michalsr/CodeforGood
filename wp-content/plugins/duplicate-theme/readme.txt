=== Duplicate Theme ===
Contributors: Muller Digital Inc.
Donate link: http://news.mullerdigital.com/wordpress-plugin-duplicate-theme/
Tags: theme, template, theme copy, copy theme, template copy, copy template, duplicate theme, theme duplicate, duplicate template, template duplicate, customize theme, create new theme, customize template, create new template, create child theme, make child theme, child theme, copy child theme, duplicate child theme, easy child theme maker, make child theme, make copy of theme, make copy, make a duplicate theme, make a duplicate
...
Duplicate a theme, or make a child theme, quickly and easily from the admin panel. Easily rename the new theme. Works with Wordpress Network too!
...
1. Appearance -> Duplicate Theme
2. Network -> Themes -> Duplicate Theme
