=== Plugin Name ===
Contributors: weyhan
Donate link: https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=35NUBFT7QUBGA
...
* Internalization requirement fix as requested by WordPress.

**4.1.4:**

* Change default teaser template to be more WCAG compliance for accessibility.

**4.1.3:**

* More compatibility fix for current WordPress release

**4.1.2:**

* Minor bug fix
* Compatibility fix for current WordPress release
