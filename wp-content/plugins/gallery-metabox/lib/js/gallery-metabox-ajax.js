...
// bkjadd: add hover to metabox
jQuery('.be_gallery_metabox_item_wrap img').hover( 
	function() {
		var theid = jQuery(this).data('id');
		jQuery('#be_gallery_metabox_hover_id_' + theid ).fadeIn(); 
	},
	function() {
		var theid = jQuery(this).data('id');
		jQuery('#be_gallery_metabox_hover_id_' + theid ).hide(); 
	}
	 );

// redirect click to standard gallery
jQuery('#be_gallery_metabox_standardgallery').click(function() {jQuery('#insert-media-button').click();});
