...
<?php
wp_enqueue_style( 'style',  TEMPLATE_URL . '/style.css', '', 1,'all' );
wp_enqueue_style( 'suckerfish',  TEMPLATE_URL . '/suckerfish.css', 'style', 1,'screen' );
...
<div id="header">
<a href="/home/"><img src="<?php echo TEMPLATE_URL; ?>/images/logo.png" alt="Melrose Alliance Against Violence" name="logo" width="168" height="173" border="0" align="left" id="logo" /></a>
