...
<div class="post" id="post-<?php the_ID(); ?>">
	...
	<form action="/scripts/mymail.php" method="POST" name="myform">
		<input type="hidden" name="redirect" value="/home/misc/thank-you/">
		<input type="hidden" name="require" value="realname,email,sec_code">
		
		<table border="0" cellspacing="6" cellpadding="0">
			<tr valign="top">
				<td width="141" align="right"><b>Your Name*</b></td>
			  <td width="360"><input name="realname" type="text" size="40"></td>
			</tr>
			<tr valign="top">
			...
			<tr valign="top">
				...
				<td><input name="HomePhone" type="text" size="40" maxlength="40"></td>
			</tr>			
			<tr valign="top">
			...
			<tr valign="top">
				<td align="right">&nbsp;</td>
				<td><img src="/scripts/captcha.php"/></td>
			</tr>
			<tr valign="top">
				<td align="right"><b>Security Code*</b></td>
				<td><input id="sec_code" name="sec_code" type="text" style="width:120px";></td>
			</tr>
			<tr valign="top">
				<td align="right"><small>(* = required field)</small></td>
