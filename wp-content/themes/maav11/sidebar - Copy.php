...
<ul>
 <li id="search">
   ...
   <form id="searchform" method="get" action="<?php bloginfo('home'); ?>/">
	<div>
		<input type="text" name="s" id="s" size="15" value="<?php echo $x?>" onfocus="this.value=''" /> 
<input type="image" id="searchsubmit" value="Search" src="/home/images/btn_search.gif" alt="Search" align="bottom" width="20" height="20" border="0" />
	</div>
	</form>
 </li>
...
<?php if (function_exists('c2c_random_file') ) {
	$x= c2c_random_file('/wp-content/uploads/home/');
...
<!--
		...
		<?php wp_list_categories('title_li=News'); ?>
<hr />
	 
-->
 <li style="font-size:10px;"><?php wp_register('', ''); ?>
 &bull; <?php wp_loginout(); ?></li>
