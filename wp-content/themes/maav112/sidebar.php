 ...
 <li id="search">
   ...
   <form id="searchform" method="get" action="<?php bloginfo('home'); ?>/">
	...
	<div>
		...
		<input type="text" name="s" id="s" size="15" value="<?php echo $x?>" onfocus="this.value=''" /><input type="image" id="searchsubmit" value="Search" src="<?php echo TEMPLATE_URL; ?>/images/btn_search.png" alt="Search" align="bottom" width="20" height="20" border="0" />
